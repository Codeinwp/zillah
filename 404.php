				...
				<section class="error-404 not-found">
					...
					<div class="page-content">
						...
						<?php
							...
							if ( zillah_categorized_blog() ) :
						?>

						<div class="widget widget_categories">
							<h2 class="widget-title"><?php esc_html_e( 'Most Used Categories', 'zillah' ); ?></h2>
							<ul>
							<?php
						...
						<?php
							...
							$archive_content = '<p>' . sprintf( esc_html__( 'Try looking in the monthly archives. %1$s', 'zillah' ), convert_smilies( ':)' ) ) . '</p>';
